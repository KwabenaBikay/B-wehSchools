        ...
        <main className="min-h-screen bg-slate-50 flex items-center justify-center pt-24 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-3xl w-full text-center z-10 relative">
                ...
                <div className="flex justify-center mb-8">
                    <div className="relative w-32 h-32 flex items-center justify-center rounded-full bg-white shadow-2xl border-4 border-fuchsia-50 animate-bounce" style={{ animationDuration: '3.5s' }}>
                ...
                <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold text-slate-900 tracking-tight mb-8 leading-tight">
                    The Final <br className="hidden sm:block" />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#9c27b0] to-[#7e1b84]">Frontier.</span>
                </h1>

                <p className="text-lg sm:text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
                    The vision for B-Weh Senior High School is currently in the strategic planning phase. We are engineering a high-level academic environment designed to prepare leaders for top universities.
                </p>
