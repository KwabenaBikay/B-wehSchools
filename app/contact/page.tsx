        ...
        <div className="mt-8 grid gap-10 md:grid-cols-2">
          ...
          <div className="space-y-6 text-sm text-slate-700">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                <a href="tel:+233549753104" className="hover:text-violet-600 transition-colors">+233 54 975 3104</a>
              </p>
            </div>
            <div>
              <p className="font-semibold text-slate-900">Email</p>
              <p className="mt-1 text-sm text-slate-600">
                <a href="mailto:bwehschools@gmail.com" className="hover:text-violet-600 transition-colors">bwehschools@gmail.com</a>
              </p>
            </div>
            <div>
