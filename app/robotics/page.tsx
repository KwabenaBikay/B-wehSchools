...
import { FaRobot, FaBrain, FaCode, FaMicrochip, FaCalendarCheck, FaUserClock, FaArrowRight } from 'react-icons/fa';
          ...
          <div className="relative mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch">
              ...
              <div className="lg:col-span-1 flex flex-col">
                ...
                {/* THE BOUNCING BUTTON IS BACK! 
                  I made it slightly larger with thicker padding and uppercase text so it commands attention. 
                */}
                <a 
                  href={REGISTRATION_LINK} 
                  target="_blank" 
