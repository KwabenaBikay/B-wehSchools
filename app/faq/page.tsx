          ...
          {FAQS.map((faq, index) => (
            <div 
              ...
              className={`border-b border-slate-200 transition-colors duration-300 ${
                openIndex === index ? 'bg-slate-50' : 'bg-white hover:bg-slate-50/50'
              }`}
            >
              <button
              ...
              >
                <span className={`text-lg sm:text-xl font-extrabold tracking-tight transition-colors ${
                  openIndex === index ? 'text-[#7e1b84]' : 'text-slate-900 group-hover:text-[#7e1b84]'
                }`}>
                  {faq.question}
                </span>
                ...
                <span className={`ml-6 flex-shrink-0 transition-transform duration-300 ${
                  openIndex === index ? 'text-[#7e1b84] rotate-180' : 'text-slate-400 group-hover:text-[#7e1b84]'
                }`}>
